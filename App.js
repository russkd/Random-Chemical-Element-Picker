...
function pullTheElement(randNum) {
 	document.getElementById("pulledElement").innerHTML = elements[randNum];
    return elements.splice(randNum, 1);
}
